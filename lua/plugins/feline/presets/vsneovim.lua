...
local active_left = {
  ...
  {provider = git_branch},
  {provider = ' '},
  {provider = {name = 'diagnostic_errors'  , opts = {always_visible = true}}, hl = error_hl},
  {provider = {name = 'diagnostic_warnings', opts = {always_visible = true}}, hl = warn_hl},
  {provider = {name = 'diagnostic_hints'   , opts = {always_visible = true}}, hl = hint_hl},
  {provider = ' '},
  {provider = vi_mode},
}
